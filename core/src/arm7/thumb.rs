...
pub(super) fn gen_lut() -> [InstructionHandler<u16>; 256] {
    ...
    let mut lut: [InstructionHandler<u16>; 256] = [ARM7::undefined_instr_thumb; 256]; // Temp handler
    ...
    for opcode in 0..256 {
        ...
        else if opcode & 0b1111_1100 == 0b0100_0000 { ARM7::alu }
        ...
        else if opcode & 0b1111_1111 == 0b1011_0000 { ARM7::add_offset_sp }

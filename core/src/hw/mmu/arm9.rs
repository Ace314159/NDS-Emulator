...
impl HW {
    ...
    fn arm9_read_io_register(&self, addr: u32) -> u8 {
        match addr {
            ...
            0x0400_0200 => self.interrupts9.enable.read(0),
            0x0400_0201 => self.interrupts9.enable.read(1),
            0x0400_0202 => self.interrupts9.request.read(0),
    ...
    fn arm9_write_io_register(&mut self, addr: u32, value: u8) {
        match addr {
            ...
            0x0400_0200 => self.interrupts9.enable.write(&mut self.scheduler, 0, value),
            0x0400_0201 => self.interrupts9.enable.write(&mut self.scheduler, 1, value),
            0x0400_0202 => self.interrupts9.request.write(&mut self.scheduler, 0, value),

...
impl HW {
    ...
    fn arm9_read_io_register(&self, addr: u32) -> u8 {
        match addr {
            ...
            0x04000100 ..= 0x04000103 => self.timers9.timers[0].read(&self.scheduler, addr as usize % 4),
            0x04000104 ..= 0x04000107 => self.timers9.timers[1].read(&self.scheduler, addr as usize % 4),
            0x04000108 ..= 0x0400010B => self.timers9.timers[2].read(&self.scheduler, addr as usize % 4),
            0x0400010C ..= 0x0400010F => self.timers9.timers[3].read(&self.scheduler, addr as usize % 4),
    ...
    fn arm9_write_io_register(&mut self, addr: u32, value: u8) {
        match addr {
            ...
            0x0400_00EC ..= 0x0400_00EF => HW::write_byte_to_value(&mut self.dma_fill[3],
                addr as usize % 4, value),
            0x04000100 ..= 0x04000103 => self.timers9.timers[0].write(&mut self.scheduler, addr as usize % 4, value),
            0x04000104 ..= 0x04000107 => self.timers9.timers[1].write(&mut self.scheduler, addr as usize % 4, value),
            0x04000108 ..= 0x0400010B => self.timers9.timers[2].write(&mut self.scheduler, addr as usize % 4, value),
            0x0400010C ..= 0x0400010F => self.timers9.timers[3].write(&mut self.scheduler, addr as usize % 4, value),
